...
function Install_ct()
{
    ...
    'sudo ln -s /snap/bin/gost /usr/bin/gost'
    `wget --no-check-certificate https://raw.githubusercontent.com/gudk/EasyGost/master/gost.service && chmod -R 777 gost.service && mv gost.service /usr/lib/systemd/system`
    `mkdir /etc/gost && wget --no-check-certificate https://raw.githubusercontent.com/gudk/EasyGost/master/config.json && mv config.json /etc/gost && chmod -R 777 /etc/gost`
